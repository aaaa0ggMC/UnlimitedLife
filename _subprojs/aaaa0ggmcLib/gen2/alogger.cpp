...
void Logger::log(int level,dstring msg,dstring head){
    ...
    if(mode & LOG_SHOW_PROC){
        restOut.append("[PID:");
        restOut.append(to_string(GetCurrentProcessId()));
        restOut.append("]");
    }
    if(mode & LOG_SHOW_THID){
        restOut.append("[TID:");
        restOut.append(to_string(GetCurrentThreadId()));
        restOut.append("]");
    }
    restOut.append(":");
...
std::string Logger::makeMsg(int level,dstring & msg,dstring &head,bool ends){
    ...
    if(mode & LOG_SHOW_PROC){
        rout.append("[PID:");
        rout.append(to_string(GetCurrentProcessId()));
        rout.append("]");
    }
    if(mode & LOG_SHOW_THID){
        rout.append("[TID:");
        rout.append(to_string(GetCurrentThreadId()));
        rout.append("]");
    }
    rout.append(":");
    rout.append(msg);
